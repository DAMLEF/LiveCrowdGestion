...
class Agent:
    def __init__(self):
        ...
        self.reaction_time = 0.01                       # In sec
        self.desired_velocity = 2.5                     # In m/s (vi0)

        self.repulsion_amplitude = 1200                 # In Newton
        self.repulsion_characteristic_distance = 0.12   # In meter

        self.contact_stiffness = 20000                  # In kg/s²
